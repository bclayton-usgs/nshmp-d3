...
const { D3LineLegendOptions } = require('../options/D3LineLegendOptions');
...
class D3LineLegend {
   ...
   */
  hideAll() {
    this.hide(this.view.upperSubView);

    if (this.view.addLowerSubView) {
      this.hide(this.view.lowerSubView);
    }
  }
   ...
   */
  showAll() {
    this.show(this.view.upperSubView);

    if (this.view.addLowerSubView) {
      this.show(this.view.lowerSubView);
    }
  }
