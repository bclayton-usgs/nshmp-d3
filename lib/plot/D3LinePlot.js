const d3 = require('d3');
const { NshmpError, Preconditions } = require('@nshmp/nshmp-web-utils');
...
const { D3SaveFigure } = require('../save/D3SaveFigure.js');
const { D3SaveLineData } = require('../save/D3SaveLineData.js');
const { D3TextOptions } = require('../options/D3TextOptions.js');
const { D3Tooltip } = require('../util/D3Tooltip.js');
const { D3Utils } = require('../util/D3Utils.js');
...
export class D3LinePlot {
  ...
  constructor(view) {
    ...
    /** @type {D3LineLegend} */
    this.legend = new D3LineLegend(this.view);
   ...
   *    - D3LineSeriesData: The series data from the plot selection or
   *    null if unselecting
   *
