...
export class D3BaseView {
  ...
  constructor(builder) {
    ...
    /** @type {Boolean} Whether to add a grid line toggle to the header */
...
export class D3BaseViewBuilder {
  ...
  /** @private */
  constructor() {
    this._viewOptions = undefined;
    this._lowerSubViewOptions = undefined;
    this._upperSubViewOptions = undefined;
   ...
   * Default: true
   *
   * @param {Boolean} bool Whether to add the grid line toggle
   */
  addGridLinetoggle(bool) {
   ...
   * Default: true
   *
   * @param {Boolean} bool Whether to add the legend toggle
   */
